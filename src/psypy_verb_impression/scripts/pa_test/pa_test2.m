function [latent, latentLow, latentHigh] = pa_test2(x, nShuffle, alpha)
...
if nargout == 0
        ...
        title('Parallel Analysis (PA) for determining the number of components');
        xlabel('PCs'); ylabel('Eingenvalues');
end